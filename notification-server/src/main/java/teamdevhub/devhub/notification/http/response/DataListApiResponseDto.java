package teamdevhub.devhub.notification.http.response;
...
public class DataListApiResponseDto<T> {
    ...
    public static <T> DataListApiResponseDto<T> successWithDataList(SuccessCode code, List<T> data) {
        return successWithDataList(code, data, null);
    }
}
