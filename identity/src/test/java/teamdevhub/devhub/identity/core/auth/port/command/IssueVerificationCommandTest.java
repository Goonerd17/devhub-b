package teamdevhub.devhub.identity.core.auth.port.command;
...
public class IssueVerificationCommandTest {
    ...
    private static final VerificationTarget VERIFICATION_TARGET_1 = VerificationTarget.of(
            teamdevhub.devhub.identity.core.auth.domain.vo.verification.VerificationType.EMAIL, "test@test.com");
