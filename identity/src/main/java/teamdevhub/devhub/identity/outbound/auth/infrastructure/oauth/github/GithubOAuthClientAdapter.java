package teamdevhub.devhub.identity.outbound.auth.infrastructure.oauth.github;
...
import teamdevhub.devhub.identity.outbound.auth.infrastructure.oauth.OAuthHttpClient;
import teamdevhub.devhub.identity.core.auth.domain.vo.oauth.OAuthUser;
import teamdevhub.devhub.identity.outbound.auth.infrastructure.oauth.github.config.GithubOAuthConfig;
import teamdevhub.devhub.identity.outbound.auth.infrastructure.oauth.github.vo.GithubEmailResponse;
import teamdevhub.devhub.identity.outbound.auth.infrastructure.oauth.github.vo.GithubTokenResponse;
import teamdevhub.devhub.identity.outbound.auth.infrastructure.oauth.github.vo.GithubUserResponse;
import teamdevhub.devhub.identity.outbound.auth.infrastructure.oauth.http.BearerAuthHeaderProvider;
import teamdevhub.devhub.identity.outbound.auth.infrastructure.oauth.http.HttpResponse;
