package teamdevhub.devhub.web.api.skilltrend.facade;

import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import teamdevhub.devhub.web.api.skilltrend.model.response.CardInfoResponseDto;
import teamdevhub.devhub.web.api.skilltrend.model.response.MarketableSkillResponseDto;
import teamdevhub.devhub.web.api.skilltrend.model.response.PositionCountResponseDto;
import teamdevhub.devhub.web.api.skilltrend.model.response.ProjectTimelineResponseDto;
import teamdevhub.devhub.web.api.skilltrend.model.response.SkillCountResponseDto;
import teamdevhub.devhub.web.api.skilltrend.model.response.SkillDemandByPositionResponseDto;
import teamdevhub.devhub.web.api.skilltrend.model.response.SkillSupplyDemandResponseDto;
import teamdevhub.devhub.web.api.skilltrend.model.response.SkillTrendResponseDto;
import teamdevhub.devhub.readmodel.core.skilltrend.port.in.usecase.SkillTrendAnalyticsUseCase;
import teamdevhub.devhub.readmodel.core.skilltrend.port.in.usecase.SkillTrendStatisticsUseCase;
