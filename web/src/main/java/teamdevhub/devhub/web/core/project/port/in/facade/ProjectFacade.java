package teamdevhub.devhub.web.core.project.port.in.facade;
...
import teamdevhub.devhub.web.core.admin.form.port.in.facade.model.ApplicationFormResponseDto;
...
import teamdevhub.devhub.web.core.project.port.in.facade.model.ProjectDetailWithFormResponseDto;
...
public class ProjectFacade {
	...
	private final ApplicationFormDeletion applicationFormDeletion;
	private final ApplicationFormCreation applicationFormCreation;
	private final ApplicationFormQuery applicationFormQuery;
	private final MemberProjectOwnerQuery memberProjectOwnerQuery;
	...
	public void createProject(CreateProjectCommand createProjectCommand) {
		...
		List<String> additionalFormGuidList = applicationFormCreation.create(createProjectCommand.additionalFormList());
	...
	public void deleteProject(String projectGuid, CurrentUserPrincipal authenticatedUser) {
		Project project = projectUseCase.getProjectDetail(projectGuid);
		if(!(MemberRole.ADMIN.name().equals(authenticatedUser.roleName()) || project.getUserGuid().equals(authenticatedUser.userGuid()))) {
		...
		applicationFormDeletion.deleteApplicationForms(deleteApplicationFormGuids);
	}
	...
	public void updateProject(String projectGuid, UpdateProjectCommand updateProjectCommand, CurrentUserPrincipal authenticatedUser) {
		...
		List<String> additionalFormGuidList = applicationFormCreation.create(updateProjectCommand.additionalFormList());
	...
	public ProjectDetailWithFormResponseDto getProjectDetailWithForm(String projectGuid) {
		...
		List<ApplicationFormView> standardForms = applicationFormQuery.findStandard(applicationFormGuids);
		List<ApplicationFormView> customForms = applicationFormQuery.findCustomized(applicationFormGuids);
